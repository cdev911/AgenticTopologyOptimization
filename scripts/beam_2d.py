...
def build_problem(config_path=None):
    ...
    opt.setdefault("output_prefix", "beam_2d")
...
def main():
    parser = argparse.ArgumentParser(description="Run the 2D beam topology optimization example")
...
# mpirun -n 8 python3 scripts/beam_2d.py --config config/beam_2d.json
